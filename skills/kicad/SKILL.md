...
- `analyze_pcb.py --full`
- `cross_analysis.py`
- `analyze_emc.py` (lives in the `emc` sister skill — invoke as `<emc-skill-path>/scripts/analyze_emc.py`, not under the kicad skill's `<skill-path>/scripts/`)
